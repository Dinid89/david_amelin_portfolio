...
<ol className="relative border-s border-default">                  
    <li className="mb-10 ms-4">
        ...
        <time className="text-sm font-normal leading-none text-body">February 2022</time>
        <h3 className="text-lg font-semibold text-heading my-2">Application UI code in Tailwind CSS</h3>
