...
import heroImg from "../assets/hero.jpg"; // ton image si tu veux l'utiliser
...
function HomeBanner() {
    return (
        ...
        <>
         {/* Hero section */}
      <section className="min-h-screen flex flex-col md:flex-row items-center justify-center bg-black text-white px-4 md:px-20">
        {/* Texte */}
